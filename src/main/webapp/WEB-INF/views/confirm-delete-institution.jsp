...
<div id="wrapper">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="/user/add" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                class="fas fa-download fa-sm text-white-50"></i> Dodaj instytucje</a>
    </div>
    ...
    <div class="row justify-content-start">
        <div class="col-lg-6">
            <div style="background-color: white; padding: 20px;">
                <h1>Usuwanie instytucji</h1>
                <h2>Wybrana instytucja zostanie usunięta !</h2>
                <h3>Czy na pewno chcesz usunąć wybraną instytucję?</h3>
              <div class="button-confirm" style="display: flex"> <form method="post" action="/admin/institution/delete/${institution.id}">
                    <input type="submit" name="zgoda" value="TAK" class="btn btn-danger">
              </form>
                  <button class="btn btn-secondary"><a href="/admin/homepage" style="color: white">NIE</a> </button></div>
            </div>
        </div>
    </div>
</div>
